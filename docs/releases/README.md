...
2. Wait for the draft GitHub release to be created by GoReleaser.
3. Copy the matching `docs/releases/vX.Y.Z.md` contents into the GitHub release body.
4. Publish the draft release once the packaging workflows have succeeded.

Files:

- `RELEASE_TEMPLATE.md` - reusable structure for future releases
- `v1.0.0.md` - curated notes for the first public Lune release
